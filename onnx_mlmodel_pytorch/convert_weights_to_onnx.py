...
def convert(cfg='cfg/yolov3-spp.cfg', weights='weights/yolov3-spp.weights', torch_model='weights/yolov3-spp.pt'):
    ...
    if weights.endswith('.pt'):  # if PyTorch format
        ...
        torch.save(chkpt, torch_model)
        print("Success: converted '%s' to '*.pt'" % weights)
...
if __name__ == '__main__':
    convert('../webservice/pretrain_models/analog/yolo-obj-608-analog.cfg',
            '../webservice/pretrain_models/analog/yolo-obj-608-analog_18000.weights', '../webservice/pretrain_models/analog/yolo-obj-608-analog_18000.pt')
