...
parser.add_argument('--image_input', default='../pb_to_tflite/0000.0.JPG',
                    help='Path to a image test file.')
parser.add_argument('--image_output', default='../pb_to_tflite/0000.0_output.JPG',
                    help='Path to image predict file to save.')
args = parser.parse_args()

data_dir = '../pb_to_tflite/weights'
model_path = os.path.join(
    os.getcwd(), '../pb_to_tflite/weights/yolo-obj-608-water_15000.tflite')
