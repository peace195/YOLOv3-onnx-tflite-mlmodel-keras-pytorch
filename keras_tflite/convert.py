...
parser.add_argument('--h5_path', default='weights/yolo-obj-608-water_15000.h5',
                    help='Path to Darknet h5 weights file.')
parser.add_argument('--output_path', default='weights/yolo-obj-608-water_15000.tflite',
...
outputs, config = darknet_base(
    inputs, YOLO_VERSION='yolo-obj-608-water_15000', data_dir='weights', include_yolo_head=False)
